...
&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;
          <div style="padding-top: 2px; padding-left: 30px; margin-top: 2px;"> <a href="javascript:history.back(-1)">返回</a></div>
         &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;小区名字：${xqName} &nbsp; 楼栋号：${buildNO} &nbsp; 单元号：${cellNO} &nbsp; 户号：${houseNO}
<h2>历史数据</h2>
<div id="yhfmhistory" class="charts_grid" style="width: 1000px; height: 400px; margin: 0 auto"></div>
</body>
