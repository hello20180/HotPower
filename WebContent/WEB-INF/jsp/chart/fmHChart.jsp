...
&nbsp;
        ...
        <%--    <span style="padding-top: 2px; padding-left: 30px; margin-top: 2px;"> <a href="/HotPower/FmglController/searchInfoxq.action?xqName=<%=xqName %>&buildNo=<%=buildNO %>&cellNo=<%=cellNO %>&houseNo=<%=houseNO %>">返回</a>
