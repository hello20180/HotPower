...
<body>
  ...
  <button type="button" class="btn btn-success" onClick="openaddUserPage()">添加</button>
	...
	&nbsp;&nbsp;
			<button type="button" class="btn btn-success btn-sm"><a href="StateCharts.action">图表分析</a></button>
&nbsp;&nbsp;&nbsp;&nbsp;
	...
	<div class="modal fade bs-example-modal-sm" id="edit">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body bg-info">
					<form class="form form-horizontal" action="updateRepairS.action" method="post">
...
<div class="modal fade" id="add">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body bg-info">
					<form class="form form-horizontal" action="<c:url value='InsertRepairS.action'/>" method="post">
						...
						<div class="form-group">						
						<label for="problem" class="col-sm-2 col-sm-offset-3 control-label">申请信息:</label>
							<div class="col-sm-4">
...
function openDeletePage(){
		...
		$("#btn_delete_user").click(function(){
				...
				success : function() {
					$("#deleteUser").modal("hide");
					window.location.href="RepairlistS.action";
				}
