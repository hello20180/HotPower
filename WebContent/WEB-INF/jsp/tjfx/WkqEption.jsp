...
<script type="text/javascript">
	function searchInfo() {
		...
		var roomTemp=$('#roomTemp').val();
		var valTemp = $('#valTemp').val();
		var html = "";
		$.ajax({
			url : "WkqEptionSear.action",
			async : false,
			dataType : "json",
			data : {
				"roomTemp" : roomTemp,
...
<script type="text/javascript">
	...
	function doExportExcel() {
		...
		var roomTemp=$('#roomTemp').val();
		var valTemp = $('#valTemp').val();
		window.open("WkqdoExportExcel.action?roomTemp=" + roomTemp + "&valTemp="
				+ valTemp+ "&sfjf="+ sfjf);
	}
</script>
...
<body>
	<div class="panel panel-success">
		<div class="panel-heading">温控器异常</div>
		<div class="panel-body">
			<label for="readMTime">室内温度小于:</label>
			<input type="text" name="valTemp" size="10px" value="16" id="roomTemp" value="${roomTemp}" /> 
