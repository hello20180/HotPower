...
<hr />
		...
		<div>
			<table align="right"
				...
				<tr >
					<td align="center" colspan="2" >室温分析</td>
				</tr>
				<tr>
					<td align="left">
						<input name="wd" type="checkbox" checked="checked" value="6" />温度为0 :
					</td>
					<td align="left"><span id="chartG"></span></td>
				</tr>
				
				<tr>
					<td align="left">
						<input name="wd" type="checkbox" checked="checked" value="7" />0-15度 :
					</td>
					<td align="left"><span id="chartB"></span></td>
				</tr>
				<tr>
					<td align="left">
						<input name="wd" type="checkbox" checked="checked" value="2" />15-18度 : 
					</td>
				...
				<tr>
					<td align="left">
						<input name="wd" type="checkbox" checked="checked" value="3" />18-22度 :
					</td>
				...
				<tr>
					<td align="left">
						<input name="wd" type="checkbox" checked="checked" value="4" />22-26度 :
					</td>
					<td align="left"><span id="chartE"></span></td>
				</tr>
	           <tr>
					<td align="left">
						<input name="wd" type="checkbox" checked="checked" value="1" />大于26度:</td>
...
function ShowMaxSubValues(name) {
	 ...
	 $.ajax({
			  url:"findSwfx.action?xqName="+xqName+"&buildNo="+buildNo+"&cellNo="+cellNo+"&status="+status+"&sfjf="+sfjf+"&name="+name,
			  async:false,
			  dataType:"json",
...
function chaxun(){
    ...
    $.ajax({
        type:'get',
        url:"toeditApply.action?xqName="+xqName+"&buildNo="+buildNo+"&cellNo="+cellNo+"&status="+status+"&sfjf="+sfjf+"&apiContentStr="+apiContentStr,//请求数据的地址
