...
<script type="text/javascript">
	...
	function doExportExcel() {
		var famKd=$('#famKd').val();
		var valTemp = $('#valTemp').val();
		window.open("WkqdoExportExcel.action?famKd=" + famKd + "&valTemp="+valTemp);
	}
</script>
...
<body>
	<div class="panel panel-success">
		...
		<div class="panel-body">
			<label for="readMTime">阀门开度小于:</label>
			<input type="text" name="famKd" size="10px" value="5" id="famKd" value="${famKd}" /> 
